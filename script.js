...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateMathQuestion() {
        ...
        let displayOperation = operation; // Default sama dengan operation
        ...
        switch(operation) {
            ...
            case '*':
                ...
                answer = num1 * num2;
                displayOperation = '×'; // Ubah '*' menjadi '×'
                break;
            case '/':
                // Buat soal pembagian dengan hasil bilangan bulat
                num2 = Math.floor(Math.random() * 10) + 1; // Pembagi
    ...
    submitAnswerBtn.addEventListener('click', function() {
        ...
        if (userAnswer === currentQuestion.answer) {
            ...
            resultElement.textContent = 'Jawaban Benar! 🎉 +10 Poin';
